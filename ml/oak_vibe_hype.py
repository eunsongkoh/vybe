# vibe_hype.py
# Wide FOV + correct NN input + box mapping back to 640x360
# Adds hype_score + need_hype (yes/no flag) to JSON output
# ESC to quit.
...
with dai.Device(p) as dev:
    ...
    while True:
        ...
        if now - last_print > PRINT_INTERVAL:
            hype_score = (0.5 * (1 - vibe)) + (0.3 * (1 - trend)) + (0.2 * (1 - engagement))
